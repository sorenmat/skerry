...
pub use view::{
    ...
    clamped_line_charcol_to_pos, column_selections, compute_comment_toggles, cursor_char_linecol,
    format_position, line_comment_prefix, matching_bracket, matching_close, matching_open,
